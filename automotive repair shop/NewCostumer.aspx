<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NewCostumer.aspx.cs" Inherits="automotive_repair_shop.NewCostumer" %>
    ...
    <div class="clearfix"></div>
        ...
        <div style="width:100%; height:500px">
           ...
           <div style="width:250px;height:100%; line-height:30px;float:left">
               ...
               <br />
               <br />
               <asp:TextBox ID="TextBox1" runat="server" Width="201px" Height="25px"></asp:TextBox>
               <br />
               ...
               <br />
               <asp:TextBox ID="TextBox2" runat="server" Width="201px" Height="25px" TextMode="Password"></asp:TextBox>
               <br />
               <asp:TextBox ID="TextBox3" runat="server" Width="201px" Height="25px" TextMode="Password"></asp:TextBox>
               <br />
               ...
               <br />
               <asp:TextBox ID="TextBox6" runat="server" Height="114px" TextMode="MultiLine" Width="201px"></asp:TextBox>

           </div>
          <div style="width:150px;height:100%; margin-left:30px; line-height:30px;float:left">
           ...
           <div style="width:250px;height:100%; line-height:30px;float:left">
              ...
              <br />
               ...
               <br />
               <asp:Button ID="Button1" runat="server" Text="Submit" BackColor="#D73739" BorderStyle="None" CssClass="btn-default" ForeColor="White" Width="201px" Height="30px" OnClick="Button1_Click"></asp:Button>
