<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="changePassword.aspx.cs" Inherits="automotive_repair_shop.changePassword" %>
        ...
        <div style="width:100%; height:700px">
            <div style="margin-left:150px;margin-right:150px; height:100%" >
                ...
                <div style="height:300px" class="text-center">
                    ...
                    <br />
                    Re Password<br />
                    <asp:TextBox ID="TextBox3" runat="server" Width="168px" TextMode="Password"></asp:TextBox>
                    <br />
                    <asp:Label ID="Label1" runat="server" ForeColor="Red" Visible="False"></asp:Label>
                    <br />
                    <br />
                    <asp:Button ID="Button2" runat="server" Text="Update" BackColor="#D73739" BorderStyle="None" CssClass="btn-default" ForeColor="White" Width="168px" Height="30px" OnClick="Button1_Click"></asp:Button>
